...
#-----------------------------------------------------------------------------#
path_to_vgg = '/home/chahak/vgg19.pkl'
#-----------------------------------------------------------------------------#
...
# path_to_img ='/home/chahak/mtp-2/ClothingAttributeDataset/images/'
# path_to_file = '/home/chahak/mtp-2/ClothingAttributeDataset/'

# net = build_convnet()
# dev_npy = []
# print "Opening file/......."
# f=open(path_to_file + 'CAD_devImages.txt', 'r')
...
#     im = load_image( path_to_img +file_name)
#     print i
#     feats = compute_features(net, im).flatten()
#     feats /= norm(feats)
#     dev_npy.append(feats)

# print "Saving............."
# dev_npy = numpy.array(dev_npy)
# print dev_npy.shape
# numpy.save(path_to_file+ 'CAD_dev_ims.npy', dev_npy)
